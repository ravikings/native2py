...
contains
    ...
    subroutine pvt_set_fluid(api_gravity, gas_gravity, temp_f, icorr)
        real(dp), intent(in) :: api_gravity
        real(dp), intent(in) :: gas_gravity
        real(dp), intent(in) :: temp_f
    ...
    subroutine pvt_state(pressure, props, n)
        real(dp), intent(in)    :: pressure
        real(dp), intent(inout) :: props(n)
        integer,  intent(in)    :: n

        real(dp) :: bo, bg, bw, rsol, viso, visg, visw
        real(dp) :: rhoo, rhog, rhow, zfac, co, cg, cw
    ...
    function tubing_bhp(wellhead_p, q_oil, q_water, q_gas, diameter, &
        ...
        real(dp), intent(in) :: wellhead_p
        real(dp), intent(in) :: q_oil
        real(dp), intent(in) :: q_water
        real(dp), intent(in) :: q_gas
        real(dp), intent(in) :: diameter
        real(dp), intent(in) :: roughness
        real(dp), intent(in) :: tvd
        real(dp), intent(in) :: md
    ...
    function vogel_rate(res_pressure, flowing_bhp, q_max) result(q)
        real(dp), intent(in) :: res_pressure
        real(dp), intent(in) :: flowing_bhp
        real(dp), intent(in) :: q_max
        real(dp) :: q
        real(dp) :: iprvog
        external :: iprvog
