...
This was native2py's only Fortran front end; `fortran_fparser.py` is the real
...
That property turns out to be a premature optimisation at the sizes native2py
...
def normalize_free_form(source: str) -> str:
    ...
    generated code. Both mean touching source native2py promises not to
    touch.
