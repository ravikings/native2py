"""T12 -- `invariants.json` and its aggregate gate (native2py/invariants.py).
...
from native2py import invariants as inv
from native2py import structural_invariants as si
...
def test_uncovered_reports_tubing_bhps_undeclared_ranges():
    ...
    from native2py import lattice as lattice_mod
