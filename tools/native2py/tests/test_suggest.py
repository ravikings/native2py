...
from native2py.discovery import find_implementation_files
from native2py.suggest import POOR, READY, WORKABLE, analyse_tree
...
def test_suggest_ignores_cpp_when_headers_exist(tmp_path):
    """You point native2py at an interface, not at an implementation file."""
