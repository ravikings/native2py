"""The bit-emission wire protocol (native2py/wire.py).
...
from native2py.ir import FunctionDef, Parameter, module_from_dict

REPO_ROOT = pathlib.Path(__file__).resolve().parents[3]
PETRO_GOLDEN = REPO_ROOT / "services" / "petro_api" / "golden.json"
PETRO_IR = REPO_ROOT / "services" / "petro_api" / ".native2py" / "ir.json"
