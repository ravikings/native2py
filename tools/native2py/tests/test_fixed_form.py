...
from native2py.discovery import detect_language, find_native_sources, is_fixed_form
from native2py.parsers import fixed_form
from native2py.parsers import fortran as fortran_parser
from native2py.preprocess import IncludeError, expand_includes
...
def test_discovery_skips_generated_expanded_sources(tmp_path):
    # native2py writes INCLUDE-expanded copies under native/_expanded/.
