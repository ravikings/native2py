"""The generated numerical-regression test (see nativegate/golden.py).
...
import nativegate would mean shipping the code generator alongside the thing
it generated, or a CI job that passes locally and fails in the container.

The test itself lives in `nativegate/templates/golden_test_template.py` as a
...
PLACEHOLDERS = {
    "NATIVEGATE_PACKAGE": "package",
    "NATIVEGATE_SERVICE_NAME": "service",
    "NATIVEGATE_GOLDEN_FILENAME": "golden_filename",
}
