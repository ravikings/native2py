...
things that silently change them are exactly the things nativegate touches:
...
compiler identifications, nativegate's own version, and the SHA-256 of every
...
def provenance(sources=None, root: Path | None = None) -> dict:
    ...
    return {
        ...
        "nativegate": _nativegate_version(),
