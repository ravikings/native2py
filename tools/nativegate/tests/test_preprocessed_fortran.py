...
from nativegate.discovery import find_native_sources, requires_preprocessing
from nativegate.parsers import fortran as fortran_parser
from nativegate.preprocess import PreprocessError, run_c_preprocessor
...
def test_a_missing_gfortran_is_an_error_not_a_misparse(tmp_path, monkeypatch):
    ...
    import nativegate.preprocess as preprocess_module
