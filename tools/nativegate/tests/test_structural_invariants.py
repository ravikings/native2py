...
from nativegate import driverbuild, golden, structural_invariants as si
from nativegate.config import RangeDeclaration, ServiceConfig, StateConfig, VerificationConfig
...
nativegate.yaml says `bump` is a mutator.
"""
...
def test_hidden_global_fails_order_independent_with_add_to_mutating_message(tmp_path):
    ...
    assert "nativegate.yaml" in message
