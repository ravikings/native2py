...
from nativegate.parsers import cpp_ast
from nativegate.parsers.cpp_ast import ClangOptions
...
def test_nothing_is_scalar_bound_without_the_opt_in(tmp_path):
    ...
    # array, so nativegate must not guess — that is the project's first rule.
